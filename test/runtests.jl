...
@testset "Advent of Code 2025" begin
    ...
    @testset "day 7" begin
        @test day07_part1("day07/inputs/day07_test.txt") == 21
        @test day07_part2("day07/inputs/day07_test.txt") == 40
    end


    @testset "day 8" begin
        @test day08_part1("day08/inputs/day08_test.txt") == 40
        @test day08_part2("day08/inputs/day08_test.txt") == 25272
    end
    ...
    @testset "day 10" begin
        @test day10_part1("day10/inputs/day10_test.txt") == 7
        @test day10_part2("day10/inputs/day10_test.txt") == 33
    end


    @testset "day 11" begin
        @test day11_part1("day11/inputs/day11_test.txt") == 5
        @test day11_part2("day11/inputs/day11_test2.txt") == 2
    end
