...
@testset "day 2" begin
    @test day02_part1("day02/inputs/day02_test.txt")
    @test day02_part2("day02/inputs/day02_test.txt")
end


@testset "day 3" begin
    @test day03_part1("day03/inputs/day03_test.txt")
    @test day03_part2("day03/inputs/day03_test.txt")
end


@testset "day 4" begin
    @test day04_part1("day04/inputs/day04_test.txt")
    @test day04_part2("day04/inputs/day04_test.txt")
end
...
@testset "day 6" begin
    @test day06_part1("day06/inputs/day06_test.txt")
    @test day06_part2("day06/inputs/day06_test.txt")
end
